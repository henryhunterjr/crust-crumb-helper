...
const messageStatusConfig: Record<MessageStatus, { label: string; className: string }> = {
  ...
  message_generated: { label: 'DM Ready', className: 'bg-accent text-accent-foreground' },
  sent: { label: 'Sent', className: 'bg-primary/15 text-primary border-primary/30' },
  replied: { label: 'Replied', className: 'bg-[hsl(142,76%,36%)]/15 text-[hsl(142,76%,36%)] border-[hsl(142,76%,36%)]/30' },
};
      ...
      <DialogContent className="max-w-lg max-h-[90vh] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 flex-wrap">
            ...
            <Badge variant="outline" className={cn("text-xs", msgStatus.className)}>
              {msgStatus.label}
            </Badge>
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="flex items-center justify-between p-3 bg-muted/50 rounded-md">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="responded" className="text-sm">Replied</Label>
                </div>
              </div>
            </div>
